! function(e, r, t) {
  ...
  function c(r) {
    ...
    }), l(), this.initTextures(r.maxParticles || 8), Object.assign(this.materials, {
  ...
  Object.assign(c.prototype, {
    ...
    step: function(e) {
      ...
      if (!(e < 0 || t <= 0)) {
        r += e;
        for (var i = 0; r >= t;) i < this.maxSubSteps && this.singleStep(), r -= t, i++;
        this.interpolationValue = r / t, this.accumulator = r
      }
    },
    singleStep: function() {
    ...
    addParticle: function(e, r, t, i, n) {
      if (!(this.particleCount >= this.maxParticles)) {
        ...
        a.needsUpdate = !0;
        var s = a.image.data;
        s[o + 0] = e, s[o + 1] = r, s[o + 2] = 0, s[o + 3] = 0, (a = this.dataTextures.mass).needsUpdate = !0, (s = a.image.data)[o + 0] = t, s[o + 1] = 1 & i ? 1 : 0, s[o + 2] = 2 & i ? 1 : 0, s[o + 3] = 4 & i ? 1 : 0, (a = this.dataTextures.group).needsUpdate = !0, (s = a.image.data)[o + 0] = 1 & i ? 1 : 0, s[o + 1] = 2 & i ? 1 : 0, s[o + 2] = 4 & i ? 1 : 0, s[o + 3] = 8 & i ? 1 : 0, (a = this.dataTextures.springs).needsUpdate = !0, s = a.image.data;
    ...
    connectParticles(e, r, t) {
      ...
      function n(t) {
        for (var n, a, o = p(e, t.image.width, t.image.height), s = p(r, t.image.width, t.image.height), l = 0; l < 4; l++)
          ...
          t.image.data[o + n] = r, t.image.data[s + a] = e, t.needsUpdate = !0
        }
      }
    },
    ...
    reset: function() {
      for (var e in this.time = 0, this.particleCount = 0, this.dataTextures) {
        ...
        r.needsUpdate = !0;
        for (var t = r.image.data, i = 0; i < t.length; i++) t[i] = 0
      }
    },
    flushData: function() {
    ...
    flushDataToRenderTarget: function(e, r) {
      ...
      t.uniforms.texture.value = r, t.uniforms.res.value.set(e.width, e.height), this.fullscreenQuad.material = t, this.renderer.render(this.scenes.fullscreen, this.fullscreenCamera, e, !0), t.uniforms.texture.value = null, this.fullscreenQuad.material = null
    },
    ...
    setRenderTargetSubData: function(r, t, i, n) {
      ...
      for (var c = new e.Vector4, d = this.onePointPerParticleGeometry.attributes, u = 0; u < r.length; u += 128) {
        ...
        for (var m = 0; m < p; m++) t(c, u + m), d.particleIndex.array[m] = r[u + m], d.data.array[4 * m + 0] = c.x, d.data.array[4 * m + 1] = c.y, d.data.array[4 * m + 2] = c.z, d.data.array[4 * m + 3] = c.w;
    ...
    resetGridStencil: function() {
      ...
      var t = this.renderer;
      t.setClearColor(0, 1), t.clearTarget(this.textures.grid, !0, !0, !0);
      ...
      for (var o = 0; o < 2; o++)
        for (var s = 0; s < 2; s++) {
          var l = o + 2 * s;
          0 !== l && (this.materials.stencil.uniforms.quadrant.value = l, i.stencil.setFunc(a.ALWAYS, l, 4294967295), t.render(this.scenes.stencil2, this.fullscreenCamera, this.textures.grid, !1))
        }
    ...
    updateGrid: function() {
      ...
      t.stencil.setFunc(i.EQUAL, 3, 4294967295), t.stencil.setOp(i.INCR, i.INCR, i.INCR), this.mapParticleToCellMesh.material = n, n.uniforms.posTex.value = this.textures.particleRead.texture, n.uniforms.posTex2.value = this.dataTextures.mass.texture, r.render(this.scenes.mapParticlesToGrid, this.fullscreenCamera, this.textures.grid, !1), n.uniforms.posTex.value = null, n.uniforms.posTex2.value = null, this.mapParticleToCellMesh.material = null, t.stencil.setTest(!1)
    },
    updateParticles: function() {
      var r = this.renderer,
        t = r.state.buffers,
        i = (r.context, this.materials.updateParticles);
      i || (i = this.materials.updateParticles = new e.ShaderMaterial({
        ...
        defines: this.getDefines()
      })), t.depth.setTest(!1), t.stencil.setTest(!1), this.fullscreenQuad.material = this.materials.updateParticles, i.uniforms.fixedTime.value = this.fixedTime, i.uniforms.posTex.value = this.textures.particleRead.texture, i.uniforms.particleTex2.value = this.dataTextures.mass, i.uniforms.groupTex.value = this.dataTextures.group, i.uniforms.particleSprings.value = this.textures.springsRead.texture, i.uniforms.particleSpringsDiagonal.value = this.textures.springsDiagonalRead.texture, i.uniforms.explodeTex.value = this.textures.explode.texture, r.render(this.scenes.fullscreen, this.fullscreenCamera, this.textures.particleWrite, !1), i.uniforms.explodeTex.value = null, i.uniforms.particleSpringsDiagonal.value = null, i.uniforms.particleSprings.value = null, i.uniforms.particleTex2.value = null, i.uniforms.groupTex.value = null, i.uniforms.posTex.value = null, this.fullscreenQuad.material = null, this.swapTextures("particleRead", "particleWrite")
    },
    ...
    updateExplodeParticle: function() {
      ...
      if (!t) {
        ...
        i.addAttribute("position", new e.BufferAttribute(o, 3)).addAttribute("particleIndex", new e.BufferAttribute(s, 1)), this.mapParticleToExplodeMesh = new e.Points(i, t), this.scenes.mapParticlesToExplode.add(this.mapParticleToExplodeMesh)
      }
    ...
    updateExplodedParticle: function() {
      ...
      t || (t = this.materials.captureExploded = new e.ShaderMaterial({
        ...
        defines: this.getDefines()
      })), t.uniforms.explodeTex.value = this.textures.explode.texture, this.fullscreenQuad.material = t, r.render(this.scenes.fullscreen, this.fullscreenCamera, this.textures.exploded, !1), this.fullscreenQuad.material = null, t.uniforms.explodeTex.value = null
    },
    ...
    hasExploded: function() {
      ...
      return this.readByteData(e, this.textures.exploded.texture, this.textures.fourUnsignedBytes), e[0] > 0
    },
    updateTrackedParticleData: function() {
      ...
      if (!t) {
        ...
        for (var i = new e.BufferGeometry, n = new Float32Array(3 * this.maxTrackedParticles), o = new Float32Array(this.maxTrackedParticles), s = 0; s < this.maxTrackedParticles; s++) o[s] = s;
        i.addAttribute("position", new e.BufferAttribute(n, 3)).addAttribute("particleTrackedIndex", new e.BufferAttribute(this.particleTrackedIndices, 1)).addAttribute("vertexIndex", new e.BufferAttribute(o, 1)), this.mapParticleToTrackedMesh = new e.Points(i, t), this.scenes.mapParticlesToTracked.add(this.mapParticleToTrackedMesh)
      }
      this.mapParticleToTrackedMesh.geometry.attributes.particleTrackedIndex.needsUpdate = !0, this.mapParticleToTrackedMesh.geometry.setDrawRange(0, this.maxTrackedParticles), this.mapParticleToTrackedMesh.material = t, t.uniforms.posTex.value = this.textures.particleRead.texture, r.render(this.scenes.mapParticlesToTracked, this.fullscreenCamera, this.textures.tracked, !0), t.uniforms.posTex.value = null, this.mapParticleToTrackedMesh.material = null, this.readByteData(this.trackedParticleData, this.textures.tracked.texture, this.textures.trackedUnsigned)
    },
    ...
    readByteData: function(r, t, i) {
      ...
      this.fullscreenQuad.material = a, a.uniforms.texture.value = t, a.uniforms.resolution.value.set(i.width, i.height), this.renderer.render(this.scenes.fullscreen, this.fullscreenCamera, i, !0), a.uniforms.texture.value = null, this.fullscreenQuad.material = null;
    ...
    swapTextures: function(e, r) {
      var t = this.textures;
      if (!t[e]) throw new Error("missing texture " + e);
      if (!t[r]) throw new Error("missing texture " + r);
      var i = t[e];
      t[e] = t[r], t[r] = i
    },
    ...
    setSpherePosition: function(e, r, t) {
      if (0 !== e) throw new Error("Multiple spheres not supported yet");
      this.params3.x = r, this.params3.y = t
    },
    getSpherePosition: function(e, r) {
      if (0 !== e) throw new Error("Multiple spheres not supported yet");
      r.x = this.params3.x, r.y = this.params3.y
    }
  });
  var h, g, y, T, b, P, w, S, I, A, k, M, C, V, D, R, E, F, _, U, G, B, z, L, j, O, q, N, X, W = "\r\n// Convert an index to an UV-coordinate\r\nvec2 indexToUV(float index, vec2 res){\r\n    vec2 uv = vec2(mod(index/res.x,1.0), floor( index/res.y ) / res.x);\r\n    return uv;\r\n}\r\n\r\nuniform sampler2D particleTex;\r\nuniform sampler2D paletteTex;\r\n\r\nuniform float size;\r\nuniform float playerParticleId;\r\nuniform vec2 cameraMin;\r\nuniform vec2 cameraMax;\r\nuniform float time;\r\n\r\n#ifndef USE_VERTEX_POSITION_FOR_PARTICLES\r\nattribute float particleIndex;\r\n#endif\r\nattribute float particleColor;\r\n\r\nvarying vec4 color;\r\n\r\nvoid main() {\r\n\r\n#ifdef USE_VERTEX_POSITION_FOR_PARTICLES\r\n    vec4 particlePosAndVel = vec4(position.xy, vec2(0.0));\r\n#else\r\n    vec2 particleUV = indexToUV(particleIndex,vec2(PARTICLE_RESOLUTION));\r\n    vec4 particlePosAndVel = texture2D(particleTex,particleUV);\r\n#endif\r\n\r\n    vec2 playerParticleUV = indexToUV(playerParticleId,vec2(PARTICLE_RESOLUTION)).xy;\r\n    vec4 playerParticlePosAndVel = texture2D(particleTex,playerParticleUV);\r\n\r\n    color = texture2D(paletteTex,vec2(mod(time,1.0), particleColor));\r\n\r\n    vec2 cameraPos = clamp( playerParticlePosAndVel.xy, cameraMin, cameraMax );\r\n\r\n    vec4 mvPosition = modelViewMatrix * vec4( particlePosAndVel.xy - cameraPos, position.z, 1.0 );\r\n\r\n    gl_PointSize = size;\r\n    gl_Position = projectionMatrix * mvPosition;\r\n}\r\n",
    ...
    K = -1 !== location.search.indexOf("debug"),
  ...
  function ee(e, r, t) {
    if (e && ne) {
      t = t || 0;
      var i = .6 + r;
      i = f(i, 0, 1), e.playbackRate.linearRampToValueAtTime(i, ne.currentTime + t)
    }
  }
  var re, te, ie, ne, ae, oe = !1,
    se = 0,
    le = 0;
  ...
  if (me = !1, pe = navigator.userAgent || navigator.vendor || window.opera, (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(pe) || /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(pe.substr(0, 4))) && (me = !0), me)(he = document.getElementById("mobile-info")).style.display = "flex", he.innerHTML += '<p><img src="jelly-mario.gif" width="60%"></p>';
      ...
      var t = (r = document.createElement("canvas")).getContext("webgl") || r.getContext("experimental-webgl"),
        i = t.createTexture();
      if (null === t.getExtension("OES_texture_float")) return !1;
      t.bindTexture(t.TEXTURE_2D, i), t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, 2, 2, 0, t.RGBA, t.FLOAT, null), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, t.LINEAR), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, t.LINEAR);
      var n = t.createFramebuffer();
      t.bindFramebuffer(t.FRAMEBUFFER, n), t.framebufferTexture2D(t.FRAMEBUFFER, t.COLOR_ATTACHMENT0, t.TEXTURE_2D, i, 0);
      var a = t.checkFramebufferStatus(t.FRAMEBUFFER) === t.FRAMEBUFFER_COMPLETE;
      return t.deleteTexture(i), t.deleteFramebuffer(n), t.bindTexture(t.TEXTURE_2D, null), t.bindFramebuffer(t.FRAMEBUFFER, null), a
    }()) {
    ...
    Promise.all([function() {
      ...
      ne = new e, (ae = ne.createGain()).gain.setValueAtTime(1, ne.currentTime), ae.connect(ne.destination);
      var r = document.getElementById("toggleSoundCheckbox");
      r.checked = "running" === ne.state, r.onchange = function() {
      ...
      var i = (t = Array.from(new Set(t))).map(e => (function(e) {
        return ue[e] ? Promise.resolve(ue[e]) : (ce(), fetch(e).then(e => e.arrayBuffer()).then(e => new Promise(function(r, t) {
      ...
      if ("running" === ne.state) return Promise.resolve();
      var e = document.getElementById("play"),
        r = document.getElementById("playButton");
      return e.style.display = "", ve.style.display = "none", new Promise(function(t, i) {
        r.addEventListener("click", function() {
          ne.resume(), t(), e.style.display = "none"
        })
      })
    }).then(function() {
      ! function() {
        (y = new e.WebGLRenderer).setPixelRatio(1), Y.appendChild(y.domElement), window.addEventListener("resize", Ie, !1), h = new e.Scene, C = new e.Vector2(512, 512), w = new c({
          maxSubSteps: 1,
        ...
        }), I = 4 * w.maxParticles, K && (window.world = w);
        w.radius;
        var r = 256 * w.radius;
        (g = new e.OrthographicCamera(-1, 1, 1, -1, .1, 50)).position.z = r / 2, h.add(g),
          function() {
            for (var r = new e.ShaderMaterial({
              ...
              }), t = new Float32Array(w.maxParticles), i = 0; i < w.maxParticles; i++) t[i] = i;
            var n = new Float32Array(w.maxParticles),
              a = new Float32Array(3 * w.maxParticles),
              o = new e.BufferGeometry;
            o.addAttribute("position", new e.BufferAttribute(a, 3)).addAttribute("particleIndex", new e.BufferAttribute(t, 1)).addAttribute("particleColor", new e.BufferAttribute(n, 1)), (A = new e.Points(o, r)).frustumCulled = !1, h.add(A)
          ...
          }), i = new Float32Array(I), n = new Float32Array(3 * I), a = new e.BufferGeometry, a.addAttribute("position", new e.BufferAttribute(n, 3)).addAttribute("particleColor", new e.BufferAttribute(i, 1)), (k = new e.Points(a, t)).frustumCulled = !1, h.add(k), 0, z = {
            38: 0,
            40: 0,
            39: 0,
            37: 0,
            ...
            if (0 === z[e.keyCode]) switch (e.keyCode) {
              case 38:
                w.time;
                break;
              case 32:
            ...
            0 === z[e.keyCode] && 38 === e.keyCode && w.time, z[e.keyCode] = 0, Ee()
          }),
          function() {
            var r = new e.Vector2,
              t = {
                ...
                mousemove: function(e) {
                  ...
                  r.set(e.pageX - t.left, e.pageY - t.top), r.x /= t.width, r.y /= t.height
                },
                mousup: function() {}
              };
            for (var i in t) window.addEventListener(i, t[i])
          }(), Ie();
        var t, i, n, a
      }();
      var i = H.firstLevel;
      ...
      for (var a in Te(i), Se(), w.singleStep(), w.materials) {
      ...
      ve.style.display = "none",
        function() {
          if (!K) return;
          (T = new r).domElement.style.position = "absolute", T.domElement.style.top = "0px", Y.appendChild(T.domElement), S = {
            paused: !1,
            gravity: w.gravity.y,
            level: R,
            zoom: 1,
            debugTimeScale: 1
          }, (b = new t.GUI).add(w, "stiffness", 0, 5e3, .1), b.add(w, "damping", 0, 100, .1), b.add(w, "drag", 0, 1, .01), b.add(w, "friction", 0, 10, .001), b.add(w, "fixedTimeStep", .001, .1, .001), b.add(S, "debugTimeScale", 0, 5, .01), b.add(S, "paused"), b.add(S, "gravity", -2, 2, .001).onChange(function(e) {
            w.gravity.y = e
      ...
      throw ve.innerText = "Something went wrong :(", e
    })
  } else {
    var he = document.getElementById("mobile-info");
    document.getElementById("mobile-info-message").innerText = "It seems like your device doesn't support WebGL. Sorry!", he.style.display = "flex", he.innerHTML += '<p><img src="jelly-mario.gif" width="60%"></p>'
  }

  function ge(e, r, t, i) {
    e[0] = r[0] * w.radius * 2, e[1] = 2 * w.radius * i - r[1] * w.radius * 2
  }

  function ye(r, t, i, n) {
    this.min = new e.Vector2(r, t), this.max = new e.Vector2(i, n)
  }

  function Te(r, t) {
    if (R = r, E = fe[r + ".png"], F = fe[r + "-mass.png"], _ = fe[r + "-groups.png"], U = fe[r + "-depth.png"], G = fe[r + "-triggers.png"], K) {
      var i = [E, F, _, U, G];
    ...
    window.ga && window.ga("send", {
      ...
      }(r) || be(), w.reset(), w.gravity.copy(H.levels[r].gravity), w.applyForceMask2.set(0, 0, 0, 1), w.applyForce2.set(-.03, 0), xe = 0, j = -100, D = new Float32Array(4), w.boxMin.set(0, 0), w.boxMax.set(2 * w.radius * E.width, 2 * w.radius * E.height), P = E.height;
    var a = Pe(E),
      o = Pe(_),
      s = Pe(F),
      l = Pe(U),
    ...
    for (var m = [0, 0, 0, 0], x = 4 * (H.levels[r].backgroundColorPixel[0] + E.width * H.levels[r].backgroundColorPixel[1]), f = 0; f < 4; f++) m[f] = a[f + x];
    K && console.log(m), M = [];
    ...
    var S = new Map;
    1, 2, 2, 4, 8, 2, 2, w.applyGravityMask.set(0, 0, 1, 1), S.set(4278190335, 2), S.set(4278255360, 1), S.set(4294901760, 6), S.set(4294967295, 10), S.set(4278255615, 2);
    ...
    for (f = 0; f < E.width; f++)
      for (var z = 0; z < E.height; z++) {
        ...
        if (W !== m[0] || Q !== m[1] || Y !== m[2]) {
          var se = u[Fe];
          if (6 === (Te = S.get(se))) I.set(Math.min(f, I.x), Math.min(z, I.y)), A.set(Math.max(f, A.x), Math.max(z, A.y));
          else if (4278255615 === se) {
            var le = !1;
            k.forEach(function(e) {
              e.contains(f, z) && (le = !0), e.max.x + 1 === f ? (e.max.x++, le = !0) : e.min.x - 1 === f && (e.min.x--, le = !0), e.max.y + 1 === z ? (e.max.y++, le = !0) : e.min.y - 1 === z && (e.min.y--, le = !0)
            }), le || k.push(new ye(f, z, f, z))
          }
          S.has(se) && C++
        }
      }
    console.log(k), K && console.log("Using " + v(C, w.maxParticles) + "% of particle texture"), J.length = 0;
    for (f = 0; f < E.width; f++)
      for (z = 0; z < E.height; z++) {
        w.particleCount % 255 == 0 && w.addParticle(-100, -100, 0, 0, 0);
        var ce;
        W = a[(ce = 4 * (Fe = z * E.width + f)) + 0], Q = a[ce + 1], Y = a[ce + 2], $ = a[ce + 3];
        if (W !== m[0] || Q !== m[1] || Y !== m[2]) {
          var de = 1;
          ...
          if (S.has(se)) {
            ...
            void 0 !== we && (g.set(T(f, z), we), b[f + z * E.width] = we, M[we] = ve, Z[we] = he)
          } else 0 !== $ && J.push(pe[0], pe[1], he, ve)
        }
      }
    g.forEach(function(e, r) {
      var t, i = parseInt(r.split("_")[0], 10),
        n = parseInt(r.split("_")[1], 10);
      i > 44 && i < 48 && n > 15 && n < 19 || (void 0 !== (t = g.get(T(i, n + 1))) && w.connectParticles(e, t, !1), void 0 !== (t = g.get(T(i, n - 1))) && w.connectParticles(e, t, !1), void 0 !== (t = g.get(T(i + 1, n))) && w.connectParticles(e, t, !1), void 0 !== (t = g.get(T(i - 1, n))) && w.connectParticles(e, t, !1), void 0 !== (t = g.get(T(i - 1, n - 1))) && w.connectParticles(e, t, !0), void 0 !== (t = g.get(T(i + 1, n + 1))) && w.connectParticles(e, t, !0), void 0 !== (t = g.get(T(i - 1, n + 1))) && w.connectParticles(e, t, !0), void 0 !== (t = g.get(T(i + 1, n - 1))) && w.connectParticles(e, t, !0))
    }), L = new Map, H.levels[r].portals.forEach(function(e) {
    ...
    re = g.get(T(Se, Ie)), w.centerParticleIndex = re, w.applyTorqueMaskAndCenterParticleId.set(0, 0, 1, re), K && console.log("Player particle: " + re);
    var Ae = Math.floor((A.x + I.x) / 2),
      ke = A.y - 8,
      Me = I.y + 10;
    te = g.get(T(Ae, ke)), ie = g.get(T(Ae, Me)), te && ie || (console.error("Stretch particle not found!"), te = ie = -1), q = [], N = A.x - I.x + 1, X = A.y - I.y + 1;
    ...
    y.setClearColor(Re, 1), V = new e.DataTexture(new Uint8Array(4 * h.length * 8), 8, h.length, e.RGBAFormat);
    ...
    h.forEach(function(e, r) {
      ...
      if (o) o.animation.forEach(function(e, t) {
        V.image.data[4 * (8 * r + t) + 0] = e[0], V.image.data[4 * (8 * r + t) + 1] = e[1], V.image.data[4 * (8 * r + t) + 2] = e[2], V.image.data[4 * (8 * r + t) + 3] = e[3]
      });
      else
        for (var s = 0; s < 8; s++) V.image.data[4 * (8 * r + s) + 0] = t, V.image.data[4 * (8 * r + s) + 1] = i, V.image.data[4 * (8 * r + s) + 2] = n, V.image.data[4 * (8 * r + s) + 3] = a
    }), V.needsUpdate = !0;
    var Fe, _e = 0;
    (k.forEach(function(e) {
    ...
    }), t) && (ge(Fe = [0, 0], t, E.width, E.height), w.singleStep(), function(e, r) {
    ...
    ! function(e) {
      if (!O && H.levels[e].music.length) {
        ...
        O.buffer = ue[r], O.connect(ae), O.loop = !0, H.music[r] && (O.loopEnd = H.music[r].loopEnd, O.loopStart = H.music[r].loopStart), O.start(ne.currentTime, O.loopStart), ee(O, 0)
      }
    }(r), g = null
  }

  function be() {
    O && (O.disconnect(ae), O = null)
  }
  ...
  function Pe(e) {
    ...
    return t.mozImageSmoothingEnabled = !1, t.webkitImageSmoothingEnabled = !1, t.msImageSmoothingEnabled = !1, t.imageSmoothingEnabled = !1, t.drawImage(e, 0, 0, e.width, e.height), t.getImageData(0, 0, e.width, e.height).data
  }
  ...
  function Se() {
    k.material.uniforms.size.value = A.material.uniforms.size.value = we(), k.material.uniforms.playerParticleId.value = A.material.uniforms.playerParticleId.value = re, k.material.uniforms.paletteTex.value = A.material.uniforms.paletteTex.value = V, Ae();
    for (var e = 0; e < w.particleCount; e++) A.geometry.attributes.particleColor.array[e] = M[e], A.geometry.attributes.position.array[3 * e + 0] = 0, A.geometry.attributes.position.array[3 * e + 1] = 0, A.geometry.attributes.position.array[3 * e + 2] = Z[e];
    ...
    for (e = 0; e < I; e++)
      if (4 * e < J.length) {
        var r = J[4 * e],
          ...
          i = J[4 * e + 2],
          n = J[4 * e + 3];
        k.geometry.attributes.particleColor.array[e] = n, k.geometry.attributes.position.array[3 * e + 0] = r, k.geometry.attributes.position.array[3 * e + 1] = t, k.geometry.attributes.position.array[3 * e + 2] = i
      } else k.geometry.attributes.position.array[3 * e + 0] = 0, k.geometry.attributes.position.array[3 * e + 1] = 0;
    for (var a in J.length = 0, A.geometry.attributes) A.geometry.attributes[a].needsUpdate = !0;
    for (var a in k.geometry.attributes) k.geometry.attributes[a].needsUpdate = !0
  }
  ...
  function Ie() {
    ...
    S && (r /= S.zoom, e /= S.zoom);
    var t = 0 * w.radius;
    g.left = (r - t) / -2, g.right = (r - t) / 2, g.top = (e - t) / 2, g.bottom = (e - t) / -2, g.updateProjectionMatrix();
    var i = Y.getBoundingClientRect(),
      n = i.width,
      a = i.height;
    n / a > 256 / 240 ? y.setSize(256 / 240 * a, a) : y.setSize(n, n / (256 / 240)), k.material.uniforms.size.value = A.material.uniforms.size.value = we(), Ae()
  }
  ...
  function Ae() {
    ...
    if (t.set(0, 0), i.set(255, 255), R) {
      t.copy(H.levels[R].cameraBox.min), i.copy(H.levels[R].cameraBox.max);
      var n = t.y;
      t.y = P - i.y, i.y = P - n
    }
    t.multiplyScalar(2 * w.radius), i.multiplyScalar(2 * w.radius), t.set(t.x + e / 2, t.y + r / 2), i.set(i.x - e / 2, i.y - r / 2), t.x > i.x && (t.x = i.x = .5 * (t.x + i.x)), t.y > i.y && (t.y = i.y = .5 * (t.y + i.y)), k.material.uniforms.cameraMin.value.copy(t), k.material.uniforms.cameraMax.value.copy(i)
  }
  ...
  function ke(r) {
    requestAnimationFrame(ke),
      function(e) {
        ...
        S && S.paused || (w.step(n), w.maxSubSteps = $ > 60 ? 7 : 1);
        Me = e
      }(r), k.material.uniforms.particleTex.value = A.material.uniforms.particleTex.value = w.particleTexture, k.material.uniforms.time.value = A.material.uniforms.time.value = w.time, y.render(h, g),
      function() {
        var r = w.time;
        if (r - xe < .5) return;
        if (xe = r, Ve || De) return;
        if (w.hasExploded()) return Ve = !0, Ee(), be(), void _e("sound/smb_fireworks.mp3", function() {
          setTimeout(function() {
            _e("sound/smb_mariodie.mp3", function() {
              w.clearExploded(), Ve = !1, Te(R), Se()
            })
          }, 1e3)
        });
        var t = H.levels[R].portals.find(e => "timer" === e.type);
        if (t) null === Ce ? Ce = r : r - Ce > t.timeSeconds && (Te(t.destinationLevel), Se());
        else {
          w.readParticleData(re, D), ee(O, Re(), 1);
          ...
          if (H.levels[R].portals.forEach(function(e) {
              ...
              n === r[0] && (a = e)
            }), a && "die" === a.type) return void w.explodeParticle(re);
          if (a) {
            var o = function() {
              Te(a.destinationLevel, a.destinationPosition), Se(), De = !1
            };
            if ("pipe" === a.type) De = !0, _e("sound/smb_pipe.mp3", o);
            else if ("explosionTrigger" === a.type) {
              var s = L.get(n);
              s && (w.explodeParticle(s), w.singleStep(), w.clearExploded(), L.set(n, 0))
            } else a.sound ? (De = !0, _e(a.sound, o)) : (De = !0, o())
          }
        }
      }(), void 0 !== T && T.update()
  }
  ...
  function Ee() {
    if (Ve) w.applyForce.set(0, 0), w.params4.set(0, 0, 0, 0);
    else {
      w.params4.x = -1.2 * (z[39] - z[37]), w.applyForceMask.set(0, 0, 1, 0), w.applyForce.set(.1 * (z[39] - z[37]), 0 * (z[38] - z[40])), w.time - j > 1 && z[38] && (w.params4.y = -.5 * Math.min(0, -(z[38] - z[40])), w.params4.z = re, w.params4.w = ie, j = w.time, _e("sound/jump.mp3"))
    }
  }
  var Fe = {};
  ...
  function _e(e, r) {
    ...
    ee(t, Re()), t.buffer = ue[e], t.connect(ae), r && (t.onended = r), t.start(), Fe[e] = t
  }
}(THREE, Stats, dat);